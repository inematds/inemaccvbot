...
export function buildFase2Prompt(state: PromoState, publicos: string[]): string {
  ...
  return [
    ...
    `a usar:\n${titulos}\n`,
    'FORMATO — REGRA DURA: TODO vídeo é 16:9 (landscape, horizontal), 1080p. Antes de gerar cada',
    'um, confirme que a proporção/canvas da cena no estúdio está em 16:9 (landscape) — NUNCA 9:16',
    '(vertical/retrato). O avatar é landscape; a fase 3 é que empilha no reel 9:16. Se o estúdio',
    'abrir em 9:16, troque para 16:9 antes de gerar. Só use outro formato se o pedido disser',
